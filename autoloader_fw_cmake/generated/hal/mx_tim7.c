...
hal_tim_handle_t *mx_tim7_init(void)
{
  ...
  if (HAL_TIM_SetConfig(&hTIM7, &config) != HAL_OK)
  {
    return NULL;
  }

  /* Update Event Management */
  if (HAL_TIM_SetUpdateSource(&hTIM7, HAL_TIM_UPDATE_REGULAR) != HAL_OK)
  {
    return NULL;
  }
  if (HAL_TIM_EnableUpdateGeneration(&hTIM7) != HAL_OK)
  {
    return NULL;
  }
  ...
  HAL_CORTEX_NVIC_SetPriority(TIM7_IRQn, HAL_CORTEX_NVIC_PREEMP_PRIORITY_5, HAL_CORTEX_NVIC_SUB_PRIORITY_0);
